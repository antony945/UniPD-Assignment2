...
// class Train {
// public:
//     static std::vector<Stazione> allStations;
...
// int main(void) {
//     Train::allStations = createStations();
//     string input;
//     getline(cin, input);
//     Train tr = createTrainFromLine(Train::allStations, input);
//     tr.printTimes();
//     getline(cin, input);
//     tr = createTrainFromLine(Train::allStations, input);
//     tr.printTimes();
//     getline(cin, input);
//     tr = createTrainFromLine(Train::allStations, input);
//     tr.printTimes();
