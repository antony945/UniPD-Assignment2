...
private:
    std::vector<Rail> transitRails;     //non sono sicuro che possa servire perch� questi binari non sono occupabili dato che servono solo al transito, se non serve cancello
